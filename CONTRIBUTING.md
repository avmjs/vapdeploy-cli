# Contributing to vapdeploy-cli

Love vapdeploy-cli and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/silentcicero/vapdeploy-cli/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/vapdeploy-cli.git
   # Navigate to the newly cloned directory
   cd vapdeploy-cli
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/silentcicero/vapdeploy-cli.git
   ```
